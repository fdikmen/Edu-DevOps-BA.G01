# Network15 – Comparing TCP and UDP (TCP ve UDP Karşılaştırması)

## İçindekiler

1. 15.0.1 Webster - Why Should I Take this Module?
2. 15.0.2 What Will I Learn in this Module?
3. Kısa modül özeti
4. Özetler arası geçiş
...
- Modül, TCP ile UDP'nin farklı çalışma mantıklarını karşılaştırarak hangi uygulamada hangi protokolün seçilmesi gerektiğini anlamanı sağlar.
...
- Bu modülde, TCP ve UDP'nin temel farklarını öğrenip video konferans gibi gerçek kullanım senaryolarında neden farklı tercih edildiklerini kavrayacaksın.

---

## Kısa modül özeti

- TCP güvenilir teslimat sağlarken UDP daha düşük gecikme sunduğu için protokol seçimi uygulamanın ihtiyacına göre yapılır.
